...
public class GroupsResource {
	...
	public Object getGroup(
		...
		ArrayList<HashMap<String, Object>> members = groups.getGroupMembers(group);

		groups.updateAction(group, members, action);
		//groups.updateLocalGroupPlugs(group,members)
